...
public class SimpleUser {
    ...
    public SimpleUser(String name, String email, String login, Integer id, String nodeId, URI avatarUrl, String gravatarId, URI url, URI htmlUrl, URI followersUrl, String followingUrl, String gistsUrl, String starredUrl, URI subscriptionsUrl, URI organizationsUrl, URI reposUrl, String eventsUrl, URI receivedEventsUrl, String type, Boolean siteAdmin, String starredAt) {
        super();
        this.name = name;
        this.email = email;
        this.login = login;
    ...
    public static SimpleUser.SimpleUserBuilderBase builder() {
    ...
    public static class SimpleUserBuilder
        extends SimpleUser.SimpleUserBuilderBase<SimpleUser>
    {
        ...
        public SimpleUserBuilder(String name, String email, String login, Integer id, String nodeId, URI avatarUrl, String gravatarId, URI url, URI htmlUrl, URI followersUrl, String followingUrl, String gistsUrl, String starredUrl, URI subscriptionsUrl, URI organizationsUrl, URI reposUrl, String eventsUrl, URI receivedEventsUrl, String type, Boolean siteAdmin, String starredAt) {
            super(name, email, login, id, nodeId, avatarUrl, gravatarId, url, htmlUrl, followersUrl, followingUrl, gistsUrl, starredUrl, subscriptionsUrl, organizationsUrl, reposUrl, eventsUrl, receivedEventsUrl, type, siteAdmin, starredAt);
        }

    }

    public static abstract class SimpleUserBuilderBase<T extends SimpleUser >{

        protected T instance;

        @SuppressWarnings("unchecked")
        public SimpleUserBuilderBase() {
            // Skip initialization when called from subclass
            if (this.getClass().equals(SimpleUser.SimpleUserBuilder.class)) {
                this.instance = ((T) new SimpleUser());
            }
        }
        ...
        public SimpleUserBuilderBase(String name, String email, String login, Integer id, String nodeId, URI avatarUrl, String gravatarId, URI url, URI htmlUrl, URI followersUrl, String followingUrl, String gistsUrl, String starredUrl, URI subscriptionsUrl, URI organizationsUrl, URI reposUrl, String eventsUrl, URI receivedEventsUrl, String type, Boolean siteAdmin, String starredAt) {
            // Skip initialization when called from subclass
            if (this.getClass().equals(SimpleUser.SimpleUserBuilder.class)) {
                this.instance = ((T) new SimpleUser(name, email, login, id, nodeId, avatarUrl, gravatarId, url, htmlUrl, followersUrl, followingUrl, gistsUrl, starredUrl, subscriptionsUrl, organizationsUrl, reposUrl, eventsUrl, receivedEventsUrl, type, siteAdmin, starredAt));
            }
        }
        ...
        public SimpleUser.SimpleUserBuilderBase withName(String name) {
            ((SimpleUser) this.instance).name = name;
            return this;
        }

        public SimpleUser.SimpleUserBuilderBase withEmail(String email) {
            ((SimpleUser) this.instance).email = email;
            return this;
        }

        public SimpleUser.SimpleUserBuilderBase withLogin(String login) {
            ((SimpleUser) this.instance).login = login;
            return this;
        }

        public SimpleUser.SimpleUserBuilderBase withId(Integer id) {
            ((SimpleUser) this.instance).id = id;
            return this;
        }

        public SimpleUser.SimpleUserBuilderBase withNodeId(String nodeId) {
            ((SimpleUser) this.instance).nodeId = nodeId;
            return this;
        }

        public SimpleUser.SimpleUserBuilderBase withAvatarUrl(URI avatarUrl) {
            ((SimpleUser) this.instance).avatarUrl = avatarUrl;
            return this;
        }

        public SimpleUser.SimpleUserBuilderBase withGravatarId(String gravatarId) {
            ((SimpleUser) this.instance).gravatarId = gravatarId;
            return this;
        }

        public SimpleUser.SimpleUserBuilderBase withUrl(URI url) {
            ((SimpleUser) this.instance).url = url;
            return this;
        }

        public SimpleUser.SimpleUserBuilderBase withHtmlUrl(URI htmlUrl) {
            ((SimpleUser) this.instance).htmlUrl = htmlUrl;
            return this;
        }

        public SimpleUser.SimpleUserBuilderBase withFollowersUrl(URI followersUrl) {
            ((SimpleUser) this.instance).followersUrl = followersUrl;
            return this;
        }

        public SimpleUser.SimpleUserBuilderBase withFollowingUrl(String followingUrl) {
            ((SimpleUser) this.instance).followingUrl = followingUrl;
            return this;
        }

        public SimpleUser.SimpleUserBuilderBase withGistsUrl(String gistsUrl) {
            ((SimpleUser) this.instance).gistsUrl = gistsUrl;
            return this;
        }

        public SimpleUser.SimpleUserBuilderBase withStarredUrl(String starredUrl) {
            ((SimpleUser) this.instance).starredUrl = starredUrl;
            return this;
        }

        public SimpleUser.SimpleUserBuilderBase withSubscriptionsUrl(URI subscriptionsUrl) {
            ((SimpleUser) this.instance).subscriptionsUrl = subscriptionsUrl;
            return this;
        }

        public SimpleUser.SimpleUserBuilderBase withOrganizationsUrl(URI organizationsUrl) {
            ((SimpleUser) this.instance).organizationsUrl = organizationsUrl;
            return this;
        }

        public SimpleUser.SimpleUserBuilderBase withReposUrl(URI reposUrl) {
            ((SimpleUser) this.instance).reposUrl = reposUrl;
            return this;
        }

        public SimpleUser.SimpleUserBuilderBase withEventsUrl(String eventsUrl) {
            ((SimpleUser) this.instance).eventsUrl = eventsUrl;
            return this;
        }

        public SimpleUser.SimpleUserBuilderBase withReceivedEventsUrl(URI receivedEventsUrl) {
            ((SimpleUser) this.instance).receivedEventsUrl = receivedEventsUrl;
            return this;
        }

        public SimpleUser.SimpleUserBuilderBase withType(String type) {
            ((SimpleUser) this.instance).type = type;
            return this;
        }

        public SimpleUser.SimpleUserBuilderBase withSiteAdmin(Boolean siteAdmin) {
            ((SimpleUser) this.instance).siteAdmin = siteAdmin;
            return this;
        }

        public SimpleUser.SimpleUserBuilderBase withStarredAt(String starredAt) {
            ((SimpleUser) this.instance).starredAt = starredAt;
            return this;
        }

        public SimpleUser.SimpleUserBuilderBase withAdditionalProperty(String name, Object value) {
            ((SimpleUser) this.instance).additionalProperties.put(name, value);
            return this;
        }
